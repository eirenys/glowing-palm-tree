...
abstract class EntityDao {
    ...
    abstract suspend fun findOrderedVisitsByUserId(userId: Int, fromDate: Int?, toDate: Int?): Collection<Visit>?

    abstract suspend fun findVisitsByLocationId(locationId: Int): Collection<Visit>?
}